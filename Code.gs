...
const MAIN_SPREADSHEET_ID        = '1H6-XPoanHiTnlw0iGXHGOaCKl6KKUE0Mn0Al67HXhjI'; // 
const PERMISSIONS_SPREADSHEET_ID = '1BuhBRik-yCsimCM1hBhbqhWbzSrRg5Io0dYYWxRrfU4'; // [cite: 48]
const CLIENTS_SPREADSHEET_ID     = '1nxLkfJtDM71nPATSYzojEWSIsEjOLAo-hyqGzkVv3pY'; // [cite: 48]
const SEDES_SPREADSHEET_ID       = '10MSr7w_jMTTa63XLwirlbVIhge17CU25CiYg0PkL6HA'; // [cite: 49]
const ACTIVOS_SPREADSHEET_ID     = '19RK-dP0GyeiM76nS1rQshvP4SLwKw_jyAJ1nccfOOZk'; // [cite: 49]
// HOJAS MIGRADAS DE BIGQUERY A GOOGLE SHEETS
const PISOS_SPREADSHEET_ID       = '1u3VpCVLdmSwtUNzWG6ff1q9P7F_RYSXZG4m00_PL4pY'; // [cite: 50]
const DISPOSITIVOS_SPREADSHEET_ID = '1zWZnNtp1wORgx17ZsSAUXKrIRsOCcLl8kZesIhlMNNI'; // [cite: 51]
...
const SHEET_CONFIG = {
  ...
  'Activos (Copia)': ACTIVOS_SPREADSHEET_ID,
